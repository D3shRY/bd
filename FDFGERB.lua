...
sudo_users = {SUDO,1258395997,1354920138}   
...
if tonumber(user_id) == tonumber(1258395997) then  
var = true  
elseif tonumber(user_id) == tonumber(1354920138) then  
var = true  
...
usertext = '\n• العضو ⇠ ['..result.title_..'](t.me/'..(username or 'sourcejan')..')'
...
usertext = '\n• العضو ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcejan')..') '
status  = '\n تم ترقيته Commander في البوت'
...
usertext = '\n العضو ⇠ ['..result.title_..'](t.me/'..(username or 'hlsourcejanIl3')..')'
status  = '\n تم ترقيته Commander 🎖 في البوت'
texts = usertext..status
else
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو⇠ ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sourcejan')..') \n •'..FDFGERB1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/sourcejan)\n•["..FDFGERB_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا ⇠ ["..data.first_name_.."](T.ME/sourcejan)\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
[ مطور السورس ](t.me/N_G_8)

[ قناة السورس ](t.me/sourcejan)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'• بواسطه ⇠ ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sourcejan')..') \n تـم قفـل الدردشه')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• بواسطه ⇠['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'hlsourcejanIl3')..') \n تـم قفـل الروابط\n')  
end,nil)   
...
if result.sender_user_id_ == tonumber(1258395997) then
...
if result.id_ == tonumber(1258395997) then
send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر Source Manger \n")
return false 
end
usertext = '\n•العضو ⇠ ['..result.title_..'](t.me/'..(username or 'sourcejan')..')'
...
if userid == tonumber(1258395997) then
send(msg.chat_id_, msg.id_, "• لا يمكنك كتم SourceManger \n")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
 usertext = '\n• العضو ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'hlsourcejanIl3')..') '
 statusk  = '\n تم طرد العضو من هنا'
send(msg.chat_id_, msg.id_, usertext..statusk)
else
 usertext = '\n• العضو ⇠ '..userid..''
...
send(msg.chat_id_, msg.id_,'\n• العضو ⇠ ['..result.title_..'](t.me/'..(text1[3] or 'sourcejan')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'جان')
...
{
{text = 'SourceChannel', url="t.me/sourcejan"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/sourcejan)\n•["..FDFGERBAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
